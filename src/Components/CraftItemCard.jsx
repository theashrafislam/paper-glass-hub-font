...
const CraftItemCard = ({data}) => {
    ...
    return (
        <div to={`/viewDetailsPage/${_id}`} className="rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                <div className="space-y-2">
                    ...
                    <p className="text-gray-700 text-base mb-2"><span className='font-bold'>Short Description: </span>{shortDescription && (shortDescription.length > 50 ? shortDescription.slice(0, 80) : shortDescription)}</p>
